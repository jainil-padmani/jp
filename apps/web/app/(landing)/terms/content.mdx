Subject to these Terms of Service (this "Agreement"), [mailto.live](/) ("Mailto Live", "we", "us" and/or "our") provides access to Mailto Live's cloud platform as a service (collectively, the "Services"). By using or accessing the Services, you acknowledge that you have read, understand, and agree to be bound by this Agreement.
...
Mailto Live provides an email management tool ("the Product"). The Product is accessible at mailto.live and other domains and subdomains controlled by Us (collectively, "the Website").
